...
class Payment(models.Model):
    ...
    amount_paid = models.CharField(max_length=100)  #this amount total paid
...
class Orders(models.Model):
    ...
    user = models.ForeignKey(Account, on_delete=models.SET_NULL, null=True, verbose_name='user')
